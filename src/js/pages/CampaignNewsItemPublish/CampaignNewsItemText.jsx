              ...
              <CampaignSupportSectionWrapper>
                <CampaignSupportSection>
                  ...
                  <AdviceBoxWrapper>
                    <AdviceBox>
                      <AdviceBoxTitle>
                        Your supporters have already agreed to vote for your candidate(s)
                      </AdviceBoxTitle>
                      <AdviceBoxText>
                        Give people good news to help them to remember to vote, but don&apos;t overwhelm them with more reasons to support candidate(s) they already plan to vote for.
                      </AdviceBoxText>
                      <AdviceBoxText>
                        &nbsp;
                      </AdviceBoxText>
                      ...
                      <AdviceBoxText>
                        Many people are turned away from politics by what they consider to be excessive requests for donations. Support the candidates you care about by helping people decide who to vote for, and use other venues for fundraising.
                      </AdviceBoxText>
                      <AdviceBoxText>
                        &nbsp;
                      </AdviceBoxText>
